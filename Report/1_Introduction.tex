...
\begin{itemize}
    ...
    \item To build a lightweight decoder-only transformer language model with RAG that processes ASR generated text to produce coherent response in a modular pipeline.
\end{itemize}
