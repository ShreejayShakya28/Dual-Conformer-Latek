...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Waveform.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Mel Spectogram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Log_Mel_Spec.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Freq_Mask_20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Time_Mask_20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Time_Warp_20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ASR/Implementation Details/Spec/Aug_All_20.png}
