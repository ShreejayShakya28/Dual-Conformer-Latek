...
\subsubsection{Storage Optimization Results}
...
\textbf{FastConformer Training Curves}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/ASR/Results/shaswot-graphs/fast/epoch_train_loss.png}
    \caption{FastConformer training loss per epoch}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/ASR/Results/shaswot-graphs/fast/epoch_val_loss.png}
    \caption{FastConformer validation loss per epoch}
\end{figure}

\textbf{Indic Conformer Training Curves}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/ASR/Results/shaswot-graphs/indic/training_losses.png}
    \caption{Indic Conformer training loss}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/ASR/Results/shaswot-graphs/indic/validation_losses.png}
    \caption{Indic Conformer validation loss}
\end{figure}